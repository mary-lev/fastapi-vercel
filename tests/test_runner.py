...
def run_unit_tests():
    ...
    result = pytest.main(["tests/unit/", "-v", "--tb=short", "-m", "unit"])
    return result == 0
...
def run_integration_tests():
    ...
    result = pytest.main(["tests/integration/", "-v", "--tb=short", "-m", "integration"])
    return result == 0
...
def run_security_tests():
    ...
    result = pytest.main(["tests/security/", "-v", "--tb=short", "-m", "security"])
    return result == 0
...
def run_all_tests():
    ...
    result = pytest.main(
        ["tests/", "-v", "--tb=short", "--cov=.", "--cov-report=html:htmlcov", "--cov-report=term-missing"]
    )
    return result == 0
...
def run_performance_tests():
    ...
    result = pytest.main(["tests/", "-v", "--tb=short", "-k", "performance or concurrent or timing", "--durations=10"])
    return result == 0
