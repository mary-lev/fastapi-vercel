...
class TestComprehensiveSecurity:
    ...
    def setup_security_test_data(self, test_db):
        ...
        user = User(
            internal_user_id="security-test-user",
            hashed_sub="security_hash",
        ...
        topic = Topic(
            title="Security Topic", lesson_id=lesson.id, topic_order=1,
        ...
        task = Task(
            task_name="Security Task", task_link="security-task", points=10,
    ...
    def test_progressive_security_penalties(self, client, setup_security_test_data):
        ...
        for i in range(5):
            ...
            if i >= 2:
                ...
                test_response = client.post(f"/api/v1/students/{user.internal_user_id}/compile", json={"code": "print('test')", "language": "python"})
