...
class TestCodeExecutionWorkflow:
    ...
    def setup_code_execution_test_data(self, test_db):
        ...
        # Create user
        user = User(
            internal_user_id="code-test-user-123", hashed_sub="hash123", username="codetestuser", status="student"
        )
        test_db.add(user)
        test_db.commit()
        ...
        lesson = Lesson(
            title="Python Basics", description="Introduction to Python", course_id=course.id, lesson_order=1
        )
        test_db.add(lesson)
        test_db.commit()
    ...
    def test_complete_code_execution_workflow_success(self, client, setup_code_execution_test_data):
        ...
        compile_request = {"code": "print('Hello, World!')", "language": "python"}
        ...
        submit_request = {"code": "print('Hello, World!')", "task_id": task.id, "language": "python"}
    ...
    def test_security_violation_workflow(self, client, setup_code_execution_test_data):
        ...
        dangerous_code = {"code": "import os; os.system('rm -rf /')", "language": "python"}
        ...
        dangerous_code2 = {"code": "exec('malicious code')", "language": "python"}
    ...
    def test_multiple_code_submission_attempts(self, client, setup_code_execution_test_data, test_db):
        ...
        incorrect_request = {"code": "print('Wrong answer')", "task_id": task.id, "language": "python"}
        ...
        correct_request = {"code": "print('Hello, World!')", "task_id": task.id, "language": "python"}
    ...
    def test_text_submission_workflow(self, client, setup_code_execution_test_data, test_db):
        ...
        quiz_task = Task(
            ...
            type="TrueFalseQuiz",
            order=2,
            data={"question": "Python is a programming language. True or False?", "correct_answer": "True"},
        ...
        text_request = {"user_answer": "True", "task_id": quiz_task.id}
    ...
    def test_xss_protection_in_text_submission(self, client, setup_code_execution_test_data):
        ...
        # Attempt XSS attack
        xss_request = {"user_answer": "<script>alert('xss')</script>", "task_id": task.id}
    ...
    def test_sql_injection_protection_in_text_submission(self, client, setup_code_execution_test_data):
        ...
        sql_injection_request = {"user_answer": "'; DROP TABLE users; --", "task_id": task.id}
    ...
    def test_user_progress_tracking_workflow(self, client, setup_code_execution_test_data, test_db):
        ...
        enrollment_request = {"course_id": course.id}
    ...
    def test_concurrent_user_isolation(self, client, test_db):
        ...
        task = Task(
            task_name="Isolation Task",
            task_link="isolation-task",
            points=10,
            type="CodeTask",
            order=1,
            data={"question": "Test"},
        ...
        solution1 = {"code": "print('User 1 solution')", "task_id": task.id, "language": "python"}

        solution2 = {"code": "print('User 2 solution')", "task_id": task.id, "language": "python"}
    ...
    def test_error_recovery_workflow(self, client, setup_code_execution_test_data):
        ...
        syntax_error_code = {"code": "print('missing quote)", "language": "python"}
        ...
        valid_code = {"code": "print('Hello, World!')", "language": "python"}
