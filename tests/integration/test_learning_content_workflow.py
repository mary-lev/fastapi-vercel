...
class TestLearningContentWorkflow:
    ...
    def setup_learning_content_data(self, test_db):
        ...
        task1_1_2 = Task(
            ...
            type="TrueFalseQuiz",
            order=2,
            data={"question": "In Python, '5' and 5 are the same data type. True or False?", "correct_answer": "False"},
            topic_id=topic1_1.id,
        )
        ...
        summary1_2 = Summary(
            ...
            data={
                ...
                "key_points": ["If statements for decisions", "Loops for repetition", "Conditions use boolean logic"],
            },
            topic_id=topic1_2.id,
        )
