...
class StructuredLogger:
    ...
    def critical(self, message: str, category: str = LogCategory.ERROR, exception: Optional[Exception] = None, **kwargs):
    ...
    def security(self, message: str, event_type: str, severity: str = "medium", details: Optional[Dict] = None, **kwargs):
        """Log security event"""
