...
class Settings(BaseSettings):
    ...
    CORS_ORIGINS: str = (
        "http://localhost:3000,http://localhost:3001,http://localhost:3002,http://localhost:8000,https://frontend-template-lilac.vercel.app,https://dhdk.vercel.app"
    )

    # API server URLs for OpenAPI spec - JSON format
    API_SERVER_URLS: str = (
        '[{"url": "http://localhost:8000", "description": "Development server"}, {"url": "https://dhdk.vercel.app", "description": "Production server"}]'
    )
